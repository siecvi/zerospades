	...
	namespace ui {
		...
		class SliderKnob : UIElement {
			...
			void Render() {
				...
				r.ColorNP = Vector4(1.0F, 1.0F, 1.0F, IsEnabled ? 0.07F : 0.035F);
				r.DrawFilledRect(pos.x + 4, pos.y + 1, pos.x + size.x - 4, pos.y + size.y - 1);

				if (Dragging and Hover)
					r.ColorNP = Vector4(1.0F, 1.0F, 1.0F, IsEnabled ? 0.3F : 0.15F);
				else if (Hover)
					r.ColorNP = Vector4(1.0F, 1.0F, 1.0F, IsEnabled ? 0.2F : 0.1F);
				else
					r.ColorNP = Vector4(1.0F, 1.0F, 1.0F, IsEnabled ? 0.1F : 0.05F);
		...
		class Slider : ScrollBarBase {
			...
			void Render() {
				...
				r.ColorNP = Vector4(1.0F, 1.0F, 1.0F, IsEnabled ? 0.04F : 0.02F);
