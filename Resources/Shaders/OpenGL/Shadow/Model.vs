...
void PrepareForModelShadow(vec3 vertexCoord, vec3 normal) {
	vec4 shadowMapViewPos = shadowMapViewMatrix * vec4(vertexCoord, 1.0);
	TransformShadowMatrix(shadowMapCoord1, vertexCoord, shadowMapMatrix1);
	TransformShadowMatrix(shadowMapCoord2, vertexCoord, shadowMapMatrix2);
	TransformShadowMatrix(shadowMapCoord3, vertexCoord, shadowMapMatrix3);
