...
namespace spades {
	namespace draw {
		...
		GLDepthOfFieldFilter::GLDepthOfFieldFilter(GLRenderer& renderer)
			...
			gaussProgram = renderer.RegisterProgram("Shaders/OpenGL/PostFilters/Gauss1D.program");
			if (HighQualityDoFEnabled())
				blurProgram = renderer.RegisterProgram("Shaders/OpenGL/PostFilters/DoFBlur2.program");
			else
				blurProgram = renderer.RegisterProgram("Shaders/OpenGL/PostFilters/DoFBlur.program");
			cocGen = renderer.RegisterProgram("Shaders/OpenGL/PostFilters/DoFCoCGen.program");
			cocMix = renderer.RegisterProgram("Shaders/OpenGL/PostFilters/DoFCoCMix.program");
			gammaMix = renderer.RegisterProgram("Shaders/OpenGL/PostFilters/GammaMix.program");
			finalMix = renderer.RegisterProgram("Shaders/OpenGL/PostFilters/DoFMix.program");
			passthrough = renderer.RegisterProgram("Shaders/OpenGL/PostFilters/PassThrough.program");
		}
