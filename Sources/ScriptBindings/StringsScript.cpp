...
namespace spades {
	...
	class StringsObjectRegistrar : public ScriptObjectRegistrar {
		...
		static std::string DefaultTranslateN(const std::string& c, const std::string& sg,
		                                     const std::string& pl, int n) {
			return _TrN(c, sg, pl, n);
		}
		static std::string DefaultTranslateN(const std::string& c, const std::string& sg,
		                                     const std::string& pl, int n, const std::string& p1) {
	...
	public:
		...
		StringsObjectRegistrar() : ScriptObjectRegistrar("Strings") {}
