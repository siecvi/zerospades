...
int enet_socket_bind(ENetSocket socket, const ENetAddress* address) {
	...
	return bind(socket, (struct sockaddr*)&sin, sizeof(struct sockaddr_in)) == SOCKET_ERROR ? -1
	                                                                                        : 0;
}
...
int enet_socket_send(ENetSocket socket, const ENetAddress* address, const ENetBuffer* buffers,
	...
	if (WSASendTo(socket, (LPWSABUF)buffers, (DWORD)bufferCount, &sentLength, 0,
	              ...
	              address != NULL ? sizeof(struct sockaddr_in) : 0, NULL, NULL) == SOCKET_ERROR) {
...
int enet_socket_receive(ENetSocket socket, ENetAddress* address, ENetBuffer* buffers,
	...
	if (WSARecvFrom(socket, (LPWSABUF)buffers, (DWORD)bufferCount, &recvLength, &flags,
	                address != NULL ? (struct sockaddr*)&sin : NULL,
	                address != NULL ? &sinLength : NULL, NULL, NULL) == SOCKET_ERROR) {
