...
namespace jpge {
	...
	// JPEG chroma subsampling factors. Y_ONLY (grayscale images) and H2V2 (color images) are the
	// most common.
	...
	struct params {
		inline params()
		    : m_quality(85),
		      m_subsampling(H2V2),
		      m_no_chroma_discrim_flag(false),
		      m_two_pass_flag(false) {}
	...
	// least ~1024 bytes. If return value is true, buf_size will be set to the size of the
	// compressed data.
